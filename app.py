...
if data:
    ...
    h1.markdown(f"<h3 style='color:#ffb000; margin:0;'>🔱 BEE-INVEST UNIT</h3><small style='color:#444; font-size:8px;'>MASTER ROADMAP V33 | VOLATILITÉ : {vol_atr:.2f}$</small>", unsafe_allow_html=True)
    ...
    with col_main:
        ...
        st.markdown(f"""<div class='kz-card' style='border-left: 2px solid #555; padding: 10px;'>
            ...
            <div style='display:flex; justify-content:space-between; font-size:10px; color:#aaa;'>
                <span>1. Risque fixe 6% ({perte_gbp:.2f}£)</span>
                <span>2. SL Volatilité ({sl_dynamique:.1f}$)</span>
    ...
    with col_side:
        # 6. DOMINANCE BULL/BEAR (RÉINTÉGRÉ)
