...
# 1. Configuration & Design System (V2.1 - ACCOUNT & ROADMAP)
...
<div><div style="color:#e4e4e7; font-weight:800; font-size:14px; letter-spacing:1px;">KILLZONE <span style="color:#71717a; font-weight:normal;">| V2.1 ELITE</span></div></div>
</div>
...
""", unsafe_allow_html=True)
        ...
        with c1:
            # VOLUME PROFILE
            st.markdown("""<div class="kz-panel"><div class="kz-header">INSTITUTIONAL ZONES</div><div style="display:flex; justify-content:space-between; border-bottom:1px solid #222; padding-bottom:8px;"><div><span style="font-size:9px; color:#eab308; font-weight:bold;">POC (Point of Control)</span><br><span style="font-family:'JetBrains Mono'; font-weight:900; color:#eab308; font-size:14px;">"""+str(round(gold-1.2,1))+"""</span></div><div style="text-align:right;"><span style="font-size:9px; color:#eab308;">MAGNET</span></div></div></div>""", unsafe_allow_html=True)
