...
# 1. Configuration & Design System (V60 LOCKED)
...
# Utilisation d'un fragment pour rafraîchir sans "sauter"
...
def sync_terminal():
    try:
        ...
        with col_side:
            ...
            st.markdown(f"""<div class="intel-desk-sidebar"><p class='label' style='color:#ffb000; margin-bottom:10px;'>⚔️ STRATEGIC INTEL</p><div style="font-size:10px; color:#aaa;"><b>SMOOTH SYNC :</b> Les données s'actualisent sans saut de page.<br><i style="color:#777;">Réactivité maintenue à x25 pour ton trade au POC.</i></div></div>""", unsafe_allow_html=True)
        ...
        st.warning("⚠️ Flux en cours de synchronisation...")

# Lancement du terminal stable
sync_terminal()
