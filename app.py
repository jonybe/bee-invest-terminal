...
# 1. Configuration & Design System (KILLZONE THEME)
...
# CSS "KILLZONE" - Dark Mode Institutionnel & Anti-Scintillement
st.markdown("""
<style>
...
def sync_terminal():
    try:
        ...
        # 2. ALGORITHME DE SCORING (Inspiré Killzone)
        ...
        # 3. TIMING & SESSIONS (Heure de Paris/Genève GMT+1/+2)
        ...
        with c2:
            ...
            <div class="kz-panel">
                ...
                <div style="display:grid; grid-template-columns: 1fr 1fr; gap:10px;">
                    <div style="background:#18181b; padding:10px; border-radius:4px; border:1px solid #27272a;">
                        <div style="color:#e4e4e7; font-size:9px; font-weight:bold; margin-bottom:4px;">⏱ PATIENCE</div>
                        <div style="color:#71717a; font-size:9px;">Wait for clear 15m momentum alignment.</div>
                    </div>
                    <div style="background:#18181b; padding:10px; border-radius:4px; border:1px solid #27272a;">
                        <div style="color:#e4e4e7; font-size:9px; font-weight:bold; margin-bottom:4px;">⚖️ ASYMMETRY</div>
                        <div style="color:#71717a; font-size:9px;">Deploy only when invalidation is tight.</div>
                    </div>
                </div>
            </div>
            """, unsafe_allow_html=True)
            ...
            <div class="kz-panel">
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:8px; margin-bottom:16px;">
                    <div style="border:1px solid {'#eab308' if regime == 'RANGE' else '#222'}; text-align:center; padding:12px 0; border-radius:4px; background:{'rgba(234, 179, 8, 0.05)' if regime == 'RANGE' else '#0f0f11'}; color:{'#eab308' if regime == 'RANGE' else '#71717a'};">⟷<br><span style="font-size:9px; font-weight:bold;">RANGE</span></div>
                    <div style="border:1px solid {'#eab308' if regime == 'TRENDING' else '#222'}; text-align:center; padding:12px 0; border-radius:4px; background:{'rgba(234, 179, 8, 0.05)' if regime == 'TRENDING' else '#0f0f11'}; color:{'#eab308' if regime == 'TRENDING' else '#71717a'};">↗<br><span style="font-size:9px; font-weight:bold;">TRENDING</span></div>
                    <div style="border:1px solid {'#eab308' if regime == 'VOL EXPANSION' else '#222'}; text-align:center; padding:12px 0; border-radius:4px; background:{'rgba(234, 179, 8, 0.05)' if regime == 'VOL EXPANSION' else '#0f0f11'}; color:{'#eab308' if regime == 'VOL EXPANSION' else '#71717a'};">~<br><span style="font-size:9px; font-weight:bold;">VOLATILITY</span></div>
                </div>
