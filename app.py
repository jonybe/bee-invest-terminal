...
# 1. Configuration & Design System (KILLZONE THEME V1.2 - BULLETPROOF FIX)
...
def sync_terminal():
    try:
        ...
        # Variables de styles sécurisées
        ...
        with c2:
            ...
            <div class="session-box {asia_cls}">
                <div class="session-title">
                    ...
                    <span style="font-size:9px;">{asia_stat}</span>
                </div>
            ...
            <div class="session-box {lon_cls}">
                <div class="session-title">
                    ...
                    <span style="font-size:9px;">{lon_stat}</span>
                </div>
            ...
            <div class="session-box {ny_cls}">
                <div class="session-title">
                    ...
                    <span style="font-size:9px;">{ny_stat}</span>
                </div>
